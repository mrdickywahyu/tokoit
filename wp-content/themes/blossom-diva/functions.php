...
function blossom_diva_customizer_register( $wp_customize ) {
    ...
    $theme_info = '<p>';
    $theme_info .= sprintf( __( 'Demo Link: %1$sClick here.%2$s', 'blossom-diva' ),  '<a href="' . esc_url( 'https://demo.blossomthemes.com/blossom-diva/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p><p>';
...
function blossom_feminine_header(){ 
    ...
    <header id="masthead" class="site-header wow fadeIn header-layout-<?php echo esc_attr( $header_layout ); ?>" data-wow-delay="0.1s" itemscope itemtype="http://schema.org/WPHeader">
        ...
        <div class="header-b">
            <div class="container">
                <button aria-label="primary menu toggle button" id="primary-toggle-button"><i class="fa fa-bars"></i><?php esc_html_e( 'Navigation', 'blossom-diva' ); ?></button>
